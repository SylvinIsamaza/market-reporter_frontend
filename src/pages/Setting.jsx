...
const Settings = () => {
  ...
  return (
    <div className="h-screen w-full flex">
      ...
      <div
        className={`${
          showSidebar ? "lg:ml-[22rem]" : ""
        } flex-grow overflow-scroll bg-slate-100 `}
      >
        ...
        <div className="mx-auto px-[10px]  w-full max-w-4xl mt-8">
          <nav className="flex bg-white rounded-md  space-x-4 border-b">
            <button
              ...
              className={`pb-2 h-[60px] px-3 text-gray-700 font-medium border-b-2 ${
                activeTab === "profile"
                  ? "border-blue-600"
                  : "border-transparent"
              }`}
              ...
              <div>
                ...
                <div className="mb-6">
                  <p className="text-sm text-gray-700">
                    Share this referral code with your friends and earn rewards
                    when they sign up!
                  </p>
                ...
                <div className="flex justify-end">
                  <button
                    ...
                    } text-white font-bold py-2 px-4 rounded-lg focus:outline-none focus:ring-2`}
                  >
                    {copyToClipboardMessage
                      ? copyToClipboardMessage
                      : "Copy Referral Code"}
