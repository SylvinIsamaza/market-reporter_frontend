...
const Transaction = () => {
  ...
  const paymentData = [
    ...
    { id: 4, plan: "Basic Plan - Nov 2021", date: "14 November 2021", amount: 29.00, status: "Pending" },
    { id: 5, plan: "Basic Plan - Oct 2021", date: "15 October 2021", amount: 29.00, status: "Complete" },
  ];
  ...
  return (
    <div className="h-screen w-full flex">
      ...
      <div className="lg:ml-[22rem] mx-[0] h-full overflow-scroll flex flex-col flex-grow bg-slate-100">
        <Header />
