    ...
    <Header showSidebar={showSidebar} setShowSidebar={setShowSidebar}/>
      ...
      <div className="mx-auto w-full mt-8 px-[10px] md:px-[40px]">
          <div className="sm:flex sm:items-center sm:justify-between flex-col sm:flex-row">
            <p className="flex-1 text-base font-bold text-gray-900">Credit transactions</p>
              ...
              <tbody className="lg:border-gray-300">
                {payments.map((payment) => (
                  <tr key={payment.id}>
                    ...
                    <td className="whitespace-no-wrap py-4 text-sm font-normal text-gray-500 sm:px-6 lg:table-cell">{payment.date}</td>
                    <td className="whitespace-no-wrap py-4 text-right text-sm text-gray-600 lg:text-left px-[40px]">{payment.amount}</td>
