...
const Report = ({report:report}) => {
  return (
    <Link to={`/user/report/${report._id}`} className="flex  w-full items-center justify-center bg-white  dark:bg-navy-700 dark:text-white relative h-[15rem]   min-w-[200px] max-w-[300px] flex-1 rounded-md">
